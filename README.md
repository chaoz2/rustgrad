...
`Embedding`, `Dropout`, `LayerNorm`, `RMSNorm`, `Conv1d`, `Conv2d`, `ConvTranspose1d`, `ConvTranspose2d`, `AvgPool2d`, `AdaptiveAvgPool2d`, `MaxPool2d`, or
`Flatten` entries,
...
`AvgPool2d`, `AdaptiveAvgPool2d`, `LayerNorm`, `RMSNorm`, and `Flatten::new(start_dim)` also compose for the
