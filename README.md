...
`AvgPool2d`, `AdaptiveAvgPool2d`, values-only `AdaptiveMaxPool2d`, `LayerNorm`, `LayerNorm2d`, `GroupNorm`, `InstanceNorm`, `RMSNorm`, and `Flatten::new(start_dim)` also compose for the
