...
#[derive(Clone)]
pub(super) struct CompiledEvaluationPlan {
    pub(super) inference: CompiledEvaluationCapture,
    pub(super) inputs: BTreeMap<String, (Shape, DType)>,
    pub(super) output_names: Vec<String>,
    pub(super) parameter_inputs: BTreeMap<String, String>,
    pub(super) loss_weight_policy: Option<CompiledTokenWeightPolicy>,
    pub(super) allow_zero_valid_token_microbatches: bool,
    pub(super) capture_identity: u64,
}

#[derive(Clone)]
pub(super) struct CpuCompiledEvaluation {
    pub(super) plan: CompiledEvaluationPlan,
}
...
impl CompiledEvaluationPlan {
    pub(super) fn compile_with_parameter_plan<M, F>(
        module: &M,
    ...
    pub(super) fn compile_graph_with_parameter_plan<M, F>(
        module: &M,
        training_plan: &CompiledAdamWPlan,
        parameter_plan: ModuleParameterPlan,
        build: F,
    ...
    pub(super) fn compile_graph_with_ignore_index_parameter_plan<M, F>(
        module: &M,
        training_plan: &CompiledAdamWPlan,
        parameter_plan: ModuleParameterPlan,
        build: F,
    ...
    pub(super) fn compile_with_parameter_plan_inner<M, F>(
        module: &M,
        training_plan: &CompiledAdamWPlan,
        parameter_plan: ModuleParameterPlan,
        build: F,
    ...
    pub(super) fn validate_loss_weight(
        &self,
    ...
    pub(super) fn preflight_native_borrowed(
        &self,
        inputs: &BTreeMap<String, TensorData>,
    ...
    pub(super) fn evaluate_native_borrowed(
        &self,
        inputs: &BTreeMap<String, TensorData>,
