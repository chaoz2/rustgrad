        ...
        let output = match self {
            ...
            Self::Unary { op, input } => {
                ...
                match op {
                    ...
                    FuzzUnaryOp::Sinh => graph.unary(UnaryOp::Sinh, input),
                    FuzzUnaryOp::Cosh => graph.unary(UnaryOp::Cosh, input),
                    FuzzUnaryOp::Tanh => graph.unary(UnaryOp::Tanh, input),
                    FuzzUnaryOp::Erf => graph.unary(UnaryOp::Erf, input),
                    FuzzUnaryOp::Erfc => graph.unary(UnaryOp::Erfc, input),
                    FuzzUnaryOp::Asin => graph.unary(UnaryOp::Asin, input),
                    FuzzUnaryOp::Acos => graph.unary(UnaryOp::Acos, input),
                    FuzzUnaryOp::Atan => graph.unary(UnaryOp::Atan, input),
                    FuzzUnaryOp::Asinh => graph.unary(UnaryOp::Asinh, input),
                    FuzzUnaryOp::Acosh => graph.unary(UnaryOp::Acosh, input),
                    FuzzUnaryOp::Atanh => graph.unary(UnaryOp::Atanh, input),
