...
pub use session::{
    ...
    CompiledModuleCompileError, CompiledModuleMomentumSgdCheckpoint,
    ...
    CompiledModuleTrainingSession, CompiledMomentumSgdCheckpoint, CompiledMomentumSgdConfig,
    CompiledMomentumSgdPlan, CompiledMomentumSgdStepResult, CompiledMultiStepLr,
    CompiledScheduledAdamWCommitOnlyRuntime, CompiledScheduledAdamWRuntime,
    CompiledTrainingCommitOnlyRuntime, CompiledTrainingCompileObservation,
    CompiledTrainingCompilePhaseObservation, CompiledTrainingRatePolicyCommitOnlyRuntime,
    CompiledTrainingRatePolicyRuntime, CompiledTrainingRatePolicyWindowCommitRuntime,
    CompiledTrainingRuntime, CompiledTrainingStep, CompiledTrainingStepResult,
    CompiledTrainingWindowCommit, CompiledTrainingWindowCommitRuntime, CompiledTrainingWindowReset,
