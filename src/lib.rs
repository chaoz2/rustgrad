...
pub use session::{
    ...
    MaskedSelectOutput, MetalCompiledAdamW, MetalCompiledAdamWCommitResult, MetalCompiledAdamWPlan,
    MetalCompiledAdamWStepResult, MetalSessionResult, MetalSessionTarget, MetalSessionTrace,
