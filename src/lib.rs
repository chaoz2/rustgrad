...
pub use session::{
    ...
    CompiledAdamWCheckpoint, CompiledAdamWConfig, CompiledAdamWRuntime, CompiledAdamWStep,
    ...
    MetalCompiledAdamWPlan, MetalCompiledAdamWStepResult, MetalSessionResult, MetalSessionTrace,
