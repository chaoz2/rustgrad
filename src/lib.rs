...
pub use session::{
    ...
    CompiledTrainingStep, CompiledTrainingStepResult, CpuBinaryModuleTrainer, CpuCompiledAdamW,
    ...
    MaskedSelectOutput, MetalCompiledAdamW, MetalCompiledAdamWPlan, MetalCompiledAdamWStepResult,
