...
| Executable CUDA plan companion | 🚧 | The non-serializable `ExecutableShardedCudaPlan` retains validated primary owners and exact rendered PTX ABI artifacts for logical local stages. It is a preparation/validation boundary only; Phase 3B1 Driver submission is not yet claimed. |
