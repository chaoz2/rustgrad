...
| Lazy realization and scheduling | 🚧 | Producer-aware schedule DAG/lazy realization records interpreter/native-JIT/fallback traces. HostDense temporary planning safely reuses exact-compatible non-aliasing slots; backend-owned slots and vectorization remain boundaries. |
