...
| Convolution, pooling and Winograd | 🚧 | CPU-oracle NCHW/OIHW Conv2d supports optional channel bias, positive stride/dilation, asymmetric padding and groups/depthwise geometry. Reverse mode, pooling/Winograd, fuller dtype differential coverage and model parity remain. |
